...
public class IRPicture {
    ...
    public void setSeachAreaSize(int size) {
        searchAreaSize = size;
    }
    ...
    public IRPicture(int width, int height) {
...
//        }
    ...
    public Point getMaxTemperaturePixel() {
        return maxTempPixel;
    }

    public Point getMaxTemperaturePixelInSearchArea() {
        return maxTempPixelInSearchArea;
    }
